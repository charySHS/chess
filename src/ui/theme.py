...
class Theme:
    ...
    light_square: tuple[int, int, int] = (245, 241, 232)
    dark_square: tuple[int, int, int] = (188, 174, 153)
    background: tuple[int, int, int] = (18, 26, 39)
    background_alt: tuple[int, int, int] = (61, 86, 116)
    background_glow: tuple[int, int, int] = (237, 202, 142)
    background_grid: tuple[int, int, int, int] = (255, 255, 255, 10)
    panel_background: tuple[int, int, int] = (18, 24, 34)
    side_panel_background: tuple[int, int, int] = (23, 31, 44)
    side_panel_accent: tuple[int, int, int] = (233, 177, 101)
    side_panel_accent_soft: tuple[int, int, int, int] = (233, 177, 101, 88)
    coord_text: tuple[int, int, int] = (243, 236, 225)
    status_text: tuple[int, int, int] = (246, 243, 238)
    heading_text: tuple[int, int, int] = (251, 247, 241)
    muted_text: tuple[int, int, int] = (224, 217, 206)
    subtle_text: tuple[int, int, int] = (193, 185, 172)
    last_move_fill: tuple[int, int, int, int] = (255, 213, 129, 90)
    selected_outline: tuple[int, int, int] = (241, 201, 130)
    legal_quiet_fill: tuple[int, int, int, int] = (109, 214, 180, 146)
    legal_capture_outline: tuple[int, int, int, int] = (255, 139, 117, 214)
    drag_shadow: tuple[int, int, int, int] = (0, 0, 0, 92)
    overlay_fill: tuple[int, int, int, int] = (18, 24, 34, 152)
    win_banner: tuple[int, int, int] = (240, 229, 213)
    win_banner_text: tuple[int, int, int] = (26, 28, 32)
    promotion_panel: tuple[int, int, int] = (245, 236, 224)
    promotion_text: tuple[int, int, int] = (38, 34, 30)

    glass_fill: tuple[int, int, int, int] = (255, 255, 255, 40)
    glass_fill_strong: tuple[int, int, int, int] = (255, 255, 255, 62)
    glass_fill_soft: tuple[int, int, int, int] = (255, 255, 255, 22)
    glass_border: tuple[int, int, int, int] = (255, 248, 236, 112)
    glass_highlight: tuple[int, int, int, int] = (255, 248, 236, 64)
    glass_edge_glow: tuple[int, int, int, int] = (255, 222, 168, 34)
    glass_shadow: tuple[int, int, int, int] = (8, 12, 18, 74)
    board_frame: tuple[int, int, int, int] = (255, 231, 192, 72)
    orb_primary: tuple[int, int, int, int] = (235, 189, 126, 46)
    orb_secondary: tuple[int, int, int, int] = (141, 182, 232, 44)
    orb_tertiary: tuple[int, int, int, int] = (250, 228, 197, 34)

    piece_size_normal: int = 74
    piece_size_dragged: int = 112
    quiet_move_radius: int = 12
    capture_ring_width: int = 5
    selected_outline_width: int = 4
    label_font_size: int = 16
    status_font_size: int = 22
    panel_title_font_size: int = 26
    panel_body_font_size: int = 19
    panel_small_font_size: int = 15
